...
models = [
    'app_cl_base_v1','app_cl_base_v2','app_cl_gcate_v1','app_cl_gcate_v2','app_cl_loan_v1','app_cl_loan_v2',
    'app_cl_comp_v1','app_cl_cashloan_v1',
    'sms_cl_base_v1','sms_cl_base_v2',
    'call_cl_base0_v1',
    'cross_cl_base_v1',
    'dev_cl_base_v1','dev_cl_base_v2',
    'loan_cl_base_v2','loan_cl_base_v3_2','loan_cl_base_v4',
...
loan_df = tl.get_loans(sys_name,user,passwd,start_date='2024-04-01',end_date=sample_end_time)
...
models = [
     'sms_cl_cate0_v1','sms_cl_loan0_v1'
]
max_workers = 8
...
"""
jupyter nbconvert --to script req_and_fea_ac.ipynb
conda activate py310
python req_and_fea_ac.py
