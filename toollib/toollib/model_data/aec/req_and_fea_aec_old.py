...
models = [
    "app_ec_base_v1","app_ec_comp_v1","app_ec_gcate_v1",'app_ec_loan_v1', 'cross_ec_base_v1',
    'sms_ec_base_v1',
    'loan_ec_base_v2','loan_ec_base_v3_2',
...
for ser_name,model_list in feature_maps.items():
    ...
    for model in model_list:
        save_dir = os.path.join(feature_save_dir, model)
