...
models = [
    "app_ec_base_v1","app_ec_base_v2","app_ec_gcate_v1","app_ec_gcate_v2",'app_ec_loan_v1',"app_ec_loan_v2",
    "app_ec_comp_v1",'app_ec_cashloan_v1',
    'cross_ec_base_v1',
    'sms_ec_base_v1','sms_ec_base_v2',
    'loan_ec_base_v2','loan_ec_base_v3_2','loan_ec_base_v4',
    'ui_ec_base_v1','ui_ec_base_v2',
    'dev_ec_base_v1','dev_ec_base_v2'
]
...
loan_df = tl.get_loans(sys_name,user,passwd,start_date='2024-07-01',end_date=sample_end_time)
...
"""
jupyter nbconvert --to script req_and_fea_aec.ipynb
conda activate py310
python req_and_fea_aec.py
chmod -R +777 /home/model/mw
"""
