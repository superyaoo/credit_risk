...
models = [
    "app_th_base_v1",'app_th_base_v2',"app_th_gcate_v1",'app_th_gcate_v2','app_th_loan_v1','app_th_loan_v2','app_th_bcate_v1',
    "app_th_comp_v1",'app_th_cate_v1','app_th_cashloan_v1',
    'sms_th_base_v1','sms_th_base_v2','sms_th_comp_v1',
    'loan_th_base_v2','loan_th_base_v3_2','loan_th_base_v4',
    'call_th_base0_v1',
    'cross_th_base_v1',
    'dev_th_base_v1','dev_th_base_v2',
    'ui_th_base_v2'
]
...
loan_df = tl.get_loans(sys_name,user,passwd,start_date='2025-04-17',end_date=sample_end_time)
# 排除异常订单
loan_df = loan_df[~loan_df['app_order_id'].isin(['1361283124403404800','1361995814440566784',
                                                 '1361305713947475968','1367438390854402048',
                                                 '1367445979239530496'])]
...
sample_df = loan_df[(loan_df['extension_count']==0)&(loan_df['installment_num']==1)]
...
models = [
    'sms_th_cate_v1','sms_th_loan0_v1'
]
max_workers = 8
...
"""
jupyter nbconvert --to script req_and_fea_ath.ipynb
conda activate py310
python req_and_fea_ath.py
